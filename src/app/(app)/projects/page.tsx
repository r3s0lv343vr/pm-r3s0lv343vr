...
import { NewProjectTourForm } from "@/components/walkthrough/new-project-tour-form";
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid gap-4 lg:grid-cols-3">
            ...
            {projects.map((p) => {
              ...
              return (
                <Link
                  ...
                  data-tour-highlight={highlighted ? "1" : undefined}
                  className={cn(
                    "block rounded-xl border border-slate-800 bg-slate-950/50 p-4 hover:border-cyan-500/30",
                    highlighted && "tour-target-active tour-vibrate border-cyan-300/80"
                  )}
                >
                  ...
                  {highlighted ? (
                    <p className="mt-3 text-xs font-medium text-cyan-200">
                      ← Click this project to continue
                    </p>
                  ) : null}
                </Link>
              );
        ...
        <Card data-tour="new-project-card">
